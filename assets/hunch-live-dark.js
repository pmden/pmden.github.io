...
.hb-modal{position:fixed;z-index:50;top:50%;left:50%;transform:translate(-50%,-46%);width:min(400px,calc(100vw - 40px));background:#17181B;border:1px solid #2A2C30;border-radius:14px;padding:22px;box-shadow:0 24px 60px rgba(0,0,0,.6);opacity:0;pointer-events:none;transition:opacity .18s,transform .18s;font-family:'Inter',system-ui,sans-serif;color:#F2F2EF;}\
...
.hb-grip{display:none;width:38px;height:4px;border-radius:3px;background:#3a4147;margin:0 auto 14px;}\
...
.hb-pill.yes{background:#2E4A37;color:#Bfe6cd;border:1px solid #3d6b4e;}\
.hb-pill.no{background:#4a2321;color:#e6b3b0;border:1px solid #6b3d3a;}\
.hb-pill.opt{background:#1B1D21;color:#E8C56A;border:1px solid #4a3f22;}\
.hb-close{background:none;border:none;color:#7C7E7A;font-size:24px;line-height:1;cursor:pointer;padding:0 2px;}\
.hb-close:hover{color:#F2F2EF;}\
.hb-q{font-size:12.5px;color:#7C7E7A;line-height:1.5;margin:0 0 16px;}\
.hb-tabs{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:16px;}\
.hb-tab{font-family:inherit;font-size:13px;padding:11px;border-radius:9px;background:#1B1D21;border:1px solid #2A2C30;color:#A9ABA6;cursor:pointer;display:flex;justify-content:center;gap:7px;transition:.12s;}\
.hb-tab b{color:#F2F2EF;}\
.hb-tab.on.yes{background:#2E4A37;border-color:#5E9C7B;color:#F2F2EF;}\
.hb-tab.on.no{background:#4a2321;border-color:#C0504D;color:#F2F2EF;}\
.hb-opts{display:flex;flex-direction:column;gap:8px;margin-bottom:16px;max-height:180px;overflow-y:auto;}\
.hb-opt{font-family:inherit;display:flex;justify-content:space-between;gap:8px;font-size:13px;padding:11px 13px;border-radius:9px;background:#1B1D21;border:1px solid #2A2C30;color:#A9ABA6;cursor:pointer;text-align:left;}\
.hb-opt.on{border-color:#D4A03A;color:#F2F2EF;box-shadow:0 0 0 1px #D4A03A inset;}\
.hb-opt b{color:#F2F2EF;}\
.hb-lbl{display:flex;justify-content:space-between;align-items:baseline;font-size:12px;color:#7C7E7A;margin-bottom:7px;}\
.hb-lbl .bal{color:#A9ABA6;}\
.hb-amt{display:flex;align-items:center;background:#0E0F11;border:1px solid #2A2C30;border-radius:10px;padding:0 14px;margin-bottom:10px;}\
.hb-amt input{flex:1;background:none;border:none;outline:none;color:#F2F2EF;font-family:'Source Serif 4',serif;font-size:26px;font-weight:600;padding:13px 0;width:100%;}\
.hb-amt .unit{font-size:12px;color:#7C7E7A;letter-spacing:.05em;}\
.hb-chips{display:flex;gap:7px;margin-bottom:16px;}\
.hb-chips button{flex:1;font-family:inherit;font-size:12px;color:#A9ABA6;background:#1B1D21;border:1px solid #2A2C30;border-radius:8px;padding:8px 0;cursor:pointer;transition:.12s;}\
.hb-chips button:hover{border-color:#5E9C7B;color:#F2F2EF;}\
.hb-calc{background:#0E0F11;border:1px solid #2A2C30;border-radius:10px;padding:13px 15px;margin-bottom:16px;}\
...
.hb-row .k{color:#7C7E7A;}.hb-row .v{color:#A9ABA6;font-weight:500;}\
.hb-row.win .k{color:#A9ABA6;}.hb-row.win .v{color:#5E9C7B;font-family:'Source Serif 4',serif;font-size:18px;font-weight:600;}\
.hb-cta{width:100%;font-family:inherit;font-size:15px;font-weight:600;color:#F2F2EF;border:none;border-radius:10px;padding:15px;cursor:pointer;transition:filter .12s;}\
.hb-cta:hover{filter:brightness(1.08);}\
.hb-cta.yes{background:#2E4A37;}\
.hb-cta.no{background:#C0504D;color:#1a0f0e;}\
.hb-cta.opt{background:#D4A03A;color:#1a1408;}\
.hb-fine{font-size:11px;color:#7C7E7A;line-height:1.6;margin:12px 0 0;text-align:center;}";
  ...
  function slipHTML() {
    ...
    return '<div class="hb-grip"></div>' +
      ...
      '<p class="hb-fine">Parimutuel pool · final split set at close · 5% commission on winnings.<br>Phase 1 uses Hunch Points, not money. 18+.</p>';
  }
  function render() {
  ...
  document.addEventListener('click', function (e) {
    ...
    if (!b || !b.dataset.bet) return;
    e.preventDefault();
    try {
      var bet = JSON.parse(b.dataset.bet);
  ...
  function wireWaitlist(form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(email)) { input.style.borderColor = '#C0504D'; return; }
      ...
      ok.style.cssText = 'color:#5E9C7B;font-size:14px;margin-top:10px;font-weight:500;';
